...
- (id)initWithViewControllers:(NSArray *)vcs imageArray:(NSArray *)arr
{
	...
	if (self != nil)
	{
        ...
        if(IS_IPHONE_5) {
            _transitionView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 320.0f, 568 - kTabBarHeight)];
        } else {
            _transitionView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 320.0f, 480 - kTabBarHeight)];
        }
        
        //NSLog(@"frame -- >%f",_transitionView.frame.size.height);
        ...
        if(IS_IPHONE_5) {
            _tabBar = [[LeveyTabBar alloc] initWithFrame:CGRectMake(0, 568 - kTabBarHeight, 320.0f, kTabBarHeight) buttonImages:arr];
        } else {
            _tabBar = [[LeveyTabBar alloc] initWithFrame:CGRectMake(0, 480 - kTabBarHeight, 320.0f, kTabBarHeight) buttonImages:arr];
        }
        
		_tabBar.delegate = self;
		
        KAppDelegate.leveyTabBar = _tabBar;
...
{
    NSLog(@"JJJJ-%lu-%ld-", (unsigned long)self.selectedIndex, (long)index);
